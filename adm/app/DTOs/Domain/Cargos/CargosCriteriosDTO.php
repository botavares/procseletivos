...
class CargosCriteriosDTO
{
    public ?int $pk_id_cargo_criterio = null;
    public ?int $fk_id_cargo = null;
    public ?int $fk_id_criterio = null;
    ...
    public static function fromRequest(array $data): self{
        $dto = new self();
        $dto->pk_id_cargo_criterio = !empty($data['pk_id_cargo_criterio']) ? (int) $data['pk_id_cargo_criterio'] : null;
        $dto->fk_id_cargo               = !empty($data['fk_id_cargo']) ? (int) $data['fk_id_cargo'] : null;
        $dto->fk_id_criterio         = !empty($data['fk_id_criterio']) ? (int) $data['fk_id_criterio'] : null;
