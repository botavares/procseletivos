...
class RelatoriosFormService{
    protected IncomingRequest $request;
     public function __construct(IncomingRequest $request) {
        $this->request = $request;
    }
    public function candidatosPorCurso(): array{
        $cursosModel            = new CursosModel();
        $dadosCursos = $cursosModel->orderBy('ds_nome_curso', 'ASC')->findAll();
        if (!$dadosCursos) {
    ...
    public function candidatosPorAbrangencia(): array{
        $abrangenciasModel            = new AbrangenciasModel();
        $dadosAbrangencias = $abrangenciasModel->orderBy('ds_nome_abrangencia', 'ASC')->findAll();
        if (!$dadosAbrangencias) {
            throw new \RuntimeException('Abrangências não encontradas');
        }
        return [
            'abrangencias'   => $dadosAbrangencias,
    ...
    *REFERENTE A ALTERAÇÕES NO CONTRATO
    ...
    public function prepararFormularioAlteracao(int $idContrato): array{
        ...
        return [
            ...
            'instituicao'       => $dadosInstituicao->pk_id_instituicao,
            'instituicaoNome'   => $dadosInstituicao->ds_nome,
