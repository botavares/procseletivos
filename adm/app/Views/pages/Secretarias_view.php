					...
					<div class="card card-outline card-primary">
						<div class="card-header d-flex justify-content-between align-items-center py-2">
							<div class="d-flex">
								...
								<a href="<?php echo base_url('/Secretarias/formularioCadastro') ?>" class="btn btn-primary btn-sm">
						...
						<div class="card-body p-2">
							<table id="tabela-paginada" class="table table-sm table-bordered table-striped table-hover minhaDataTable mb-0">
								...
								<tbody>
									<?php foreach ($secretarias as $valueSecretarias): ?>
										<tr>
											<td><?php echo esc($valueSecretarias->ds_nome_secretaria) ?></td>
											<td class="text-center"><?php echo esc($valueSecretarias->ds_sigla_secretaria) ?></td>
											<td class="text-center"><?php echo esc($valueSecretarias->ds_email_secretaria) ?></td>
											<td class="text-center"><?php echo mask($valueSecretarias->ds_telefone_secretaria, '(##)####-####') ?></td>
											<td class="text-center">
												<a class="btn btn-info btn-sm" href="<?php echo base_url('/Secretarias/formularioAlteracao/' . $valueSecretarias->pk_id_secretaria) ?>">
													<i class="fas fa-edit"></i>
												</a>
											</td>
											<td class="text-center">
												<button type="button" class="btn btn-danger btn-sm deleteItem" data-id="<?php echo $valueSecretarias->pk_id_secretaria . '|' . $valueSecretarias->ds_nome_secretaria ?>">
