				...
				<div class="card">
					...
					<div class="card-body">
						...
						?>
						  ...
						  <tr>
							<td align="left" class="font20 text-center"><?php echo $valueManifestos->ds_numero_manifestacao?></td>
							<?php
								if($valueManifestos->ds_agente == session()->get('id')){
							?>
								<td align="left" class="font20 text-center">
									<a class="pointer blue" href="<?php echo base_url('/Manifestacoes/formularioAlteracao/'.$valueManifestos->pk_id_manifesto)?>">
										<?php echo $valueManifestos->ds_protocolo." "?><i class="fas fa-edit"></i>
									</a>
								</td>
							<?php
								}else{
							?>
								<td align="left" class="font20 text-center"><?php echo $valueManifestos->ds_protocolo?></td>
							<?php
								}
							?>
                            ...
                            <td align="left" class="font20 text-center"><?php echo date('d/m/Y', strtotime($valueManifestos->ds_data_analise))?></td>
								<?php
									...
									$encerrado = $valueManifestos->ds_encerrado;

									if($tramitado == 1 && $respondido == 1 && $contestado == 0 && $encerrado == 0){
										$situacao = "Tramitado e Respondido";
										$cor = "green";
										$visualizar = true;
										$responder = false;
										$tramitar = false;
									}else if($tramitado == 1 && $respondido == 0 && $contestado == 0 && $encerrado == 0){
										$situacao = "Tramitado";
										$cor = "blue";
										$visualizar = true;
										$responder = true;
										$tramitar = false;
									}else if($tramitado == 0 && $respondido == 1 && $contestado == 0 && $encerrado == 0){
										$situacao = "Respondido imediato";
										$cor = "green";
										$visualizar = true;
										$responder = false;
										$tramitar = false;
									}else if($tramitado == 0 && $respondido == 0 && $contestado == 1 && $encerrado == 0){
										$situacao = "Contestado";
										$cor="red";
										$visualizar = true;
										$responder = true;
										$tramitar = false;
									}else if($tramitado == 1 && $respondido == 0 && $contestado == 1 && $encerrado == 0){
										$situacao = "Contestado";
										$cor="red";
										$visualizar = true;
										$responder = true;
										$tramitar = false;
									}else if($tramitado == 0 && $respondido == 0 && $contestado == 0 && $encerrado == 0){
										$situacao = "Pendente";
										$cor="orange";
										$visualizar = true;
										$responder = true;
										$tramitar = true;
									}else if($tramitado == 1 && $respondido == 1 && $contestado == 0 && $encerrado == 1){
										$situacao = "Encerrado";
										$cor="red";
										$visualizar = false;
										$responder = false;
										$tramitar = false;
									}else if($tramitado == 0 && $respondido == 1 && $contestado == 0 && $encerrado == 1){
										$situacao = "Encerrado";
										$cor="red";
										$visualizar = false;
										$responder = false;
							...
							<td align="center" class="font20">
								
								<a class="gerarHistorico pointer" data-id="<?php echo $valueManifestos->pk_id_manifesto?>" 
                            ...
                            <td align="center" class="font20">
								<?php if($visualizar == true){?>
									<a class="visualizarManifesto pointer" data-id="<?php echo $valueManifestos->pk_id_manifesto?>" 
							...
							<td align="center" class="font20">
							<?php if($responder == true){?>
								<?php if($contestado == 1){?>
									<a class="gerarResposta pointer" data-id="<?php echo $valueManifestos->pk_id_manifesto?>" 
									href="<?php echo base_url("/Respostas/gerarRespostaContestacao")."/".$valueManifestos->pk_id_manifesto?>">
									<i class="fas fa-comments red"></i>
									</a>
								<?php }else{?>
									<a class="gerarResposta pointer" data-id="<?php echo $valueManifestos->pk_id_manifesto?>" 
									href="<?php echo base_url("/Respostas/gerarResposta")."/".$valueManifestos->pk_id_manifesto?>">
                                	<i class="fas fa-comments"></i></a>
								<?php } ?>
							<?php } ?>
                            </td>	
							<td align="center" class="font20">
							<?php if($tramitar == true){?>
								<a class="tramitarManifesto pointer" data-id="<?php echo $valueManifestos->pk_id_manifesto?>" 
								href="<?php echo base_url("/Tramites/gerarTramite")."/".$valueManifestos->pk_id_manifesto?>">
                                <i class="fas fa-exchange-alt"></i></a>
							<?php }else{?>
								<a class="gerarResposta pointer" data-id="<?php echo $valueManifestos->pk_id_manifesto?>" 
									href="<?php echo base_url("/Tramites/sucesso")."/".$valueManifestos->pk_id_manifesto."/T"?>">
                                	Imprimir Encaminhamento</i></a>
							<?php } ?>
                            </td>
						</tr>
						<?php 
