			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Dados do Seguro</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title m0">
								<a href="<?php echo base_url("/Seguros/formularioCadastro")?>" class="ta-center btn btn-primary" >
									<p>Adicionar Seguros</p>
								</a>
							</h3>
					...
					<div class="card-body">
						...
						<?php
						  foreach($seguros as $valueSeguro){
						?>
							
						  <tr>
							  
							<td align="left"><?php echo $valueSeguro->ds_seguradora?></td>
							<td align="left"><?php echo $valueSeguro->ds_numero_seguro?></td>
							<?php if ($valueSeguro->ds_status == 1) { ?>
								<td align="left"><strong>Ativo</strong></td>
							<?php } else { ?>
								<td align="left">Inativo</td>
							<?php } ?>
							...
							<td align="center">
								<a class="editarSeguros pointer" data-id="<?php echo $valueSeguro->pk_id_seguro?>" 
								href="<?php echo base_url("/Seguros/formularioAlteracao")."/".$valueSeguro->pk_id_seguro?>">
								<i class="fas fa-edit"></i></a>
							</td>
							<td align="center"><a class="deleteItem pointer" data-id="<?php	echo $valueSeguro->pk_id_seguro.'|'.$valueSeguro->ds_seguradora?>"> <i class="fa fa-trash"></i></a>
							</td>
