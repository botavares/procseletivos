			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							<form id="formSolicitacao" class="form-horizontal col-md-12 col-lg-12" method="POST" action="<?php echo base_url()."/Secretarias/registrar"?>">

								<input type="hidden" name="action" value="update">
                                <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />

								
									<input type="hidden" name="pk_id_secretaria" value="<?php echo $dados->pk_id_secretaria?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
										...
										<input type="text" class="form-control" id="input-nome" name="ds_nome_secretaria" value="<?php echo set_value('ds_nome_secretaria',$dados->ds_nome_secretaria);?>" required >
								...
								<div class="form-group row">
									<label for="input-nome" class="col-form-label col-sm-2">Sigla da Secretaria</label>
									<div class="col-sm-10">
                                    	<span class="text text-danger"><?php echo session()->getFlashdata('errors')['ds_sigla_secretaria'] ?? ''?></span> 
										<input type="text" class="form-control" id="input-nome" name="ds_sigla_secretaria" value="<?php echo set_value('ds_sigla_secretaria',$dados->ds_sigla_secretaria);?>" required >
								...
								<div class="form-group row">
									<label for="input-nome" class="col-form-label col-sm-2">Email da Secretaria</label>
									<div class="col-sm-10">
                                    	<span class="text text-danger"><?php echo session()->getFlashdata('errors')['ds_email_secretaria'] ?? ''?></span> 
										<input type="text" class="form-control" id="input-nome" name="ds_email_secretaria" value="<?php echo set_value('ds_email_secretaria',$dados->ds_email_secretaria);?>" required >
								...
								<div class="form-group row">
									<label for="input-nome" class="col-form-label col-sm-2">Telefone da Secretaria</label>
									<div class="col-sm-10">
                                    	<span class="text text-danger"><?php echo session()->getFlashdata('errors')['ds_telefone_secretaria'] ?? ''?></span> 
										<input type="text" class="form-control telefones" id="input-nome" name="ds_telefone_secretaria" value="<?php echo set_value('ds_telefone_secretaria',$dados->ds_telefone_secretaria);?>" required >
