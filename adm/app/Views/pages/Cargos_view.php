					...
					<div class="card">
						<div class="card-header">
							<h3 class="card-title m0">
								<a href="<?php echo base_url("/Cargos/formularioCadastro")?>" class="ta-center btn btn-primary" >
									<p>Adicionar Cargo</p>
								</a>
							</h3>
						...
						?>
						  ...
						  <tr>
							...
							<td align="center">
								...
								href="<?php echo base_url("/Cargos/formularioAlteracao")."/".$valueCargos->pk_id_cargo?>">
								<i class="fas fa-edit"></i></a>
							</td>
							<td align="center"><a class="deleteItem pointer" data-id="<?php	echo $valueCargos->pk_id_cargo.'|'.$valueCargos->ds_nome_cargo?>"> <i class="fa fa-trash"></i></a>
							</td>
