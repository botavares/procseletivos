                ...
                <div class="row mb-3">
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 mb-2">
                        <a href="<?php echo base_url('Cargos') ?>" class="dash-quick-card">
                            <div class="dash-quick-icon dash-quick-icon--vagas"><i class="fas fa-user"></i></div>
                            <h6>Cargos</h6>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 mb-2">
                        <a href="<?php echo base_url('Editais') ?>" class="dash-quick-card">
                            <div class="dash-quick-icon dash-quick-icon--escolas"><i class="fas fa-bullhorn"></i></div>
                            <h6>Editais</h6>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 mb-2">
                        <a href="#" data-toggle="modal" data-target="#escolhaEditais" class="dash-quick-card">
                            <div class="dash-quick-icon dash-quick-icon--vagas"><i class="fas fa-users"></i></div>
                            <h6>Candidatos</h6>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 mb-2">
                        <a href="#" data-toggle="modal" data-target="#escolhaClassificacoes" class="dash-quick-card">
                            <div class="dash-quick-icon dash-quick-icon--info"><i class="fas fa-trophy"></i></div>
                            <h6>Classificação</h6>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-6 mb-2">
                        <a href="#" data-toggle="modal" data-target="#relatorios" class="dash-quick-card">
                            <div class="dash-quick-icon dash-quick-icon--relatorios"><i class="fas fa-file-alt"></i></div>
                            <h6>Relatórios</h6>
