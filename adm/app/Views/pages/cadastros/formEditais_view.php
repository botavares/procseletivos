                            ...
                            <form id="formEditais"
                                ...
                                <div class="form-group col-md-4 p-0">
                                    ...
                                    <select class="form-control" name="ds_status" required>
                                        <option value="1" <?= old('ds_status') == '1' ? 'selected' : '' ?>>ATIVO</option>
                                        <option value="0" <?= old('ds_status') == '0' ? 'selected' : '' ?>>INATIVO</option>
                                    </select>
                                </div>
