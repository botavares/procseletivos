			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<a href="<?php echo base_url("Setores")?>" type="button" class="btn btn-warning col-md-2 mlef20 mtop10 chanfrado" data-dismiss="modal">Voltar</a>
						<div class="card-body">
							<form id="formSetores" class="formAdmin form-horizontal col-md-12 col-lg-12" method="POST" action="<?php echo base_url()."/Setores/registrar"?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" id="input-nome-setor" name="ds_nome_setor" value="<?php echo set_value('ds_nome_setor');?>" required >
								...
								<div class="form-group row">
									...
									<div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control telefones" id="input-telefone" name="ds_telefone" value="<?php echo set_value('ds_telefone');?>" required >
