                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control" name="ds_nivel" required>
                                            ...
                                            <option value="<?= EnumEscolaridades::FUNDAMENTAL->value ?>"
                                                <?= old('ds_nivel') == EnumEscolaridades::FUNDAMENTAL->value ? 'selected' : '' ?>>
                                                Ensino Fundamental
                                            </option>
                                            <option value="<?= EnumEscolaridades::ENSINOMEDIOTECNICO->value ?>"
                                                <?= old('ds_nivel') == EnumEscolaridades::ENSINOMEDIOTECNICO->value ? 'selected' : '' ?>>
                                                Ensino Médio ou Técnico
                                            </option>
                                            <option value="<?= EnumEscolaridades::GRADUACAO->value ?>"
                                                <?= old('ds_nivel') == EnumEscolaridades::GRADUACAO->value ? 'selected' : '' ?>>
                                                Ensino Superior
                                            </option>
                                            <option value="<?= EnumEscolaridades::LATUSENSO->value ?>"
                                                <?= old('ds_nivel') == EnumEscolaridades::LATUSENSO->value ? 'selected' : '' ?>>
                                                Pós-graduação
                                            </option>
                                            <option value="<?= EnumEscolaridades::MESTRADO->value ?>"
                                                <?= old('ds_nivel') == EnumEscolaridades::MESTRADO->value ? 'selected' : '' ?>>
                                                Mestrado
                                            </option>
                                            <option value="<?= EnumEscolaridades::DOUTORADO->value ?>"
                                                <?= old('ds_nivel') == EnumEscolaridades::DOUTORADO->value ? 'selected' : '' ?>>
                                                Doutorado
                                            </option>
                                        </select>
                                    </div>
