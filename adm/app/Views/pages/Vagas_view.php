				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<a href="<?php echo base_url("/Vagas/formularioCadastro")?>" type="button" class="btn btn-success col-md-2 mtop10 chanfrado mbot10">Adicionar Vagas</a>
					...
					<div class="card-body">
						...
						<?php
						  foreach($vagas as $valueVagas){
						?>
							
						  <tr>
							  
							<td align="left"><?php echo $valueVagas->ds_nome_setor?></td>
							<td align="left"><?php echo $valueVagas->ds_nome_secretaria?></td>
							<td align="left"><?php echo $valueVagas->ds_nome_curso?></td>
							<td align="left"><?php echo $valueVagas->ds_vagas?></td>
							  <?php
							...
							<td align="center">
								<a class="editarVagas pointer" data-id="<?php echo $valueVagas->pk_id_vaga?>" 
								href="<?php echo base_url("/Vagas/formularioAlteracao")."/".$valueVagas->pk_id_vaga?>">
								<i class="fas fa-edit"></i></a>
							</td>
							<td align="center"><a class="deleteItem pointer" data-id="<?php	echo $valueVagas->pk_id_vaga.'|'.$valueVagas->ds_nome_setor.'|'.$valueVagas->ds_nome_curso?>"> <i class="fa fa-trash"></i></a>
							</td>
	...
	<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form method="POST" action="<?php echo base_url().'/Vagas/deletar'?>">
