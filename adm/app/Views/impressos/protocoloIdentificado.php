...
<!DOCTYPE html>
	...
	<div id="ladoE" style="z-index:99;">
		...
		<div id="tabelaEsquerda">
			...
			<tr><td colspan="8" class="sepV"></td> </tr>
			<tr>
				<th colspan="4" class="titTabela">NOME DO MANIFESTANTE</th>
				<th class="sepH"></th>
				<th colspan="4" class="titTabela">EMAIL</th>
			</tr>
			<tr >
				<td colspan="4"  class="datTabela"><strong><?php echo mb_strtoupper($nome, $encoding)?></strong></td>
				<td class="sepH"></td>
				<td colspan="4"  class="datTabela"><?php echo $email?></td>
			</tr>
			</table>
			...
			<tr><td colspan="8" class="sepV"></td> </tr>
			<tr>
				<th colspan="8" class="titTabela">DATA DO MANIFESTO</th>
			</tr>
			<tr >
			...
			<div class="rodape">
				<div id="link">
					<p>Para acompanhar o andamento de seu manifesto, basta acessar  </p>
				</div>
