...
<?php $encoding = mb_internal_encoding(); ?>
    ...
    <div class="clausula">
        ...
        Constitui objeto deste instrumento a rescisão do Termo de Compromisso de Estágio Extracurricular nº <?php echo $numero_termo?>, firmado pelo(a) acadêmico(a) <b><?=$nome_estagiario?></b>.
    </div>

    <div class="clausula">
        <b>CLÁUSULA SEGUNDA – DOS EFEITOS</b><br>
        A extinção do estágio dar-se-á a partir de <b><?=$data_baixa?></b>.
    </div>

    <div class="clausula">
        <b>CLÁUSULA TERCEIRA – DO FUNDAMENTO</b><br>
        Conforme cláusula 10ª do respectivo termo de compromisso de estágio, a rescisão de que trata este instrumento se fundamenta na seguinte hipótese:<br>
        <ul>
            <li><?=$motivo?>;</li>
        </ul>
    </div>
