...
<head>
    <meta charset="utf-8">
    <title><?= esc($title ?? 'Sistema Institucional') ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- Design System gov.br -->
    <link rel="stylesheet" href="<?= base_url('external/govbr/custom-capa.css') ?>"> 
    <link rel="stylesheet" href="<?= base_url('external/govbr/core.css') ?>">
    <link rel="stylesheet" href="<?= base_url('external/padroes.css') ?>">
  ...
  <div class="container-lg">
    <div class="header-top">
      <div class="header-logo">
        <div class="header-sign">SECRETARIA MUNICIPAL DE PLANEJAMENTO, GESTÃO, CIÊNCIA E TECNOLOGIA</div>
    ...
    <div class="header-bottom">
      ...
      <div class="header-search">
        <div class="br-input has-icon">
          <label for="searchbox-9476">Texto da pesquisa</label>
          <input id="searchbox-9476" type="text" placeholder="O que você procura?"/>
...
<script src="<?= base_url('external/govbr/js/govbr.bundle.min.js') ?>"></script>
</body>
</html>
