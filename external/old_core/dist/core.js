...
class BRItem {
  ...
  _setRadioSelection() {
    ...
    //br-item-secundario
    for (const radio2 of this.component.querySelectorAll(
      '.br-radio-2 input[type="radio"]'
    )) {
      if (radio2.checked) {
      ...
      radio2.addEventListener('click', (event) => {
        for (const item2 of this.component.parentElement.querySelectorAll(
          '.br-item-secundario'
        )) {
          for (const radioItem2 of item2.querySelectorAll(
            '.br-radio-2 input[type="radio"]'
          )) {
            if (radioItem2 === event.currentTarget) {
              radioItem2.setAttribute('checked', '')
              item2.classList.add('selected')
            } else {
              radioItem2.removeAttribute('checked')
